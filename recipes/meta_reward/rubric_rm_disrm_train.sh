...
TRAIN_DATA_PATH="/workspace/mnt/lxb_work/MindMirror/GRM-omni-train-v1/data/criteria_TTS/skywork_filted_train_data_lang.parquet"
TEST_DATA_PATH="/workspace/mnt/lxb_work/MindMirror/GRM-omni-train-v1/data/criteria_TTS/skywork_filted_train_data_lang.parquet"

# MODEL_PATH=/workspace/mnt/lxb_work/hf_dir/hf_model/Qwen/Qwen3-4B
...
PROJECT_NAME=criteria_TTS_v2
EXPERIMENT_NAME=Skywork_qwen-vl-sft_criteria_TTS_meta_reward
SAVE_DIR=/workspace/mnt/lxb_work/MindMirror/GRM-omni-ckpt/grm_omni_ACL/Skywork_qwen-vl-sft_criteria_TTS_meta_reward_106

CONFIG_PATH='/workspace/mnt/lxb_work/MindMirror/GRM-omni-train-v1/scripts/config'
CONFIG_NAME='criteria_TTS.yaml'
AGENT_LOOP_YAML='/workspace/mnt/lxb_work/MindMirror/GRM-omni-train-v1/src/agent_loop/agent.yaml'
